...
from src.ui.views.knowledge_bank import render_knowledge_bank_view
from src.ui.views.student_vision_rag import render_student_vision_rag_view
            ...
            with c_f2:
                ...
                target_colleges = st.multiselect(
                    ...
                    [
                        ...
                        "PESU - PES University (Ring Road)",
                        "BMSCE - BMS College of Engineering",
                        "MSRIT - Ramaiah Institute of Technology",
                        "DSCE - Dayananda Sagar College of Engg",
                        "SJCE - Sri Jayachamarajendra College",
                    ],
                    default=["RVCE - RV College of Engineering"],
                )
