...
def render_aspirant_view():
    ...
    # -------------------------------------------------------------------------
    # TAB 5: Step 5 - Voice of the Stakeholders (Alumni, Students, Recruiters, Principal & HODs)
    # -------------------------------------------------------------------------
    with tab_step5:
        st.session_state.aspirant_journey_step = 5
    ...
    with tab_lead:
        ...
        with st.form("aspirant_guided_lead_form"):
            ...
            with c_f2:
                ...
                # Multi-select component enabling multiple target institutions
                target_colleges = st.multiselect(
                    ...
                    help="You can select multiple target institutions for your counseling application.",
                )
                ...
                if not s_name or not c_email or not c_phone or not target_colleges:
                    ...
                    try:
                        with get_db() as db:
                            ...
                            # Iterate through all selected institutions and log separate admission leads
